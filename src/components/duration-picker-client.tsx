...
export function DurationPickerClient({ className = '' }: DurationPickerProps) {
  ...
  const updateDuration = (newMinutes: number) => {
    if (newMinutes < 1 || newMinutes > 1440 || !mounted) return;
    ...
    <Card className={className}>
      ...
      <CardContent className="space-y-6">
        ...
        <div style={{ 
          ...
          <div>🐛 DEBUG: mounted={mounted ? 'true' : 'false'}</div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2 justify-center">
            <button
              ...
              disabled={isRunning || inputMinutes <= 1}
              style={{ 
                padding: '6px 12px', 
            ...
            <button
              onClick={() => adjustTime(1)}
              disabled={isRunning || inputMinutes >= 1440}
              style={{ 
                padding: '6px 12px', 
                border: '1px solid #ccc',
                borderRadius: '4px',
            ...
            {PRESET_DURATIONS.map((preset) => (
              <button
                ...
                style={{
                  ...
                  border: '1px solid #ccc',
                  borderRadius: '4px',
                  backgroundColor: inputMinutes === preset.minutes ? '#007bff' : '#f8f9fa',
                  color: inputMinutes === preset.minutes ? 'white' : 'black',
                  cursor: 'pointer',
                  fontSize: '12px'
                }}
              >
...
export default DurationPickerClient;